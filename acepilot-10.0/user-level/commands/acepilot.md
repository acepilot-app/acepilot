---
name: acepilot
description: "AcePilot 10.0. /acepilot [go|plan|auto|ship|god|continue|review|status|resume] [focus]. Self-evolving autonomy. Playbooks. Session chains. Scan to PR."
...
2. Before compaction: write all state files (TASKS.md, DECISIONS.md, KNOWLEDGE.md, USER-KNOWLEDGE.md, IDENTITY.md, PATTERNS.md, ANALYTICS.md, PLAYBOOKS.md, CONTEXT.md, MODE).
3. After compaction — **verification checklist** (re-read any missing):
   - TASKS.md · DECISIONS.md · KNOWLEDGE.md · USER-KNOWLEDGE.md · IDENTITY.md · PATTERNS.md · ANALYTICS.md · PLAYBOOKS.md · MODE
...
Thirteen files in `.claude/state/`: TASKS.md, DECISIONS.md, CONTEXT.md, KNOWLEDGE.md, USER-KNOWLEDGE.md, PATTERNS.md, ANALYTICS.md, IDENTITY.md, PLAYBOOKS.md, METRICS.md (optional), MODE, CIRCUIT, STASH_REF.
...
3. Read all state: TASKS.md, DECISIONS.md, CONTEXT.md, KNOWLEDGE.md, USER-KNOWLEDGE.md, IDENTITY.md, PATTERNS.md, ANALYTICS.md, PLAYBOOKS.md, MODE, CIRCUIT, STASH_REF
...
| Mode         | Flow                              | Behavior                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------ | --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _(no arg)_   | Common                            | `"ACEPILOT 10.0 ON. [Project]. [Stack]. [Branch]."` Then use AskUserQuestion with header "Mode", question "Which mode?", options: plan (scan + show tasks), go (execute with stops on 🔴), auto (Pro — autonomous + push prompt), ship (Pro — auto + PR), god (Pro — full team, zero stops). Include continue option if TASKS.md exists (picks up remaining or scans for new). Include resume option if MODE file exists. After selection, continue as that mode. |
...
| `status`     | Skip absorb                       | Read TASKS.md + MODE + ANALYTICS.md. Report: `"AcePilot 10.0 · [mode] · [done/total] tasks · [blocked] blocked · gate accuracy [P]%"`                                                                                                                                                                                                                                                                                                                             |
