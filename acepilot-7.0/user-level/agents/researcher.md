...
Score with APS: `(Impact + Urgency + Unblock) × Confidence / Effort`. Impact 1-5 (revenue path match → 5). Urgency 1-5 (build/security=5). Unblock 0-3. Confidence 0.5/0.8/1.0. Effort 1/2/3 (by file count). P0 first regardless. MAX 30 lines:
